...
- **UI Components**: Radix UI, Tailwind CSS, shadcn/ui, [shadcn-theme-menu](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/shadcn-theme-menu)

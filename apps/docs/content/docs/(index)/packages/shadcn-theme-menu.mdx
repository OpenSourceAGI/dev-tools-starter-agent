...
{/* Generated from packages/shadcn-theme-menu/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
Source: [`packages/shadcn-theme-menu/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/shadcn-theme-menu/README.md)

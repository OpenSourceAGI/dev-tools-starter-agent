...
**🤖 Agent skills**
<br />
`npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill template-git-repo` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/template-git-repo/SKILL.md))
<br />
`npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill repo-badges` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/repo-badges/SKILL.md))

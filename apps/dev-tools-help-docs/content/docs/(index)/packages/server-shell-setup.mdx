...
description: 'One-command bootstrap for a modern dev environment: fish, nvim, nushell, bun, node, helix, starship, docker, and more.'
icon: HardDrive
---

{/* Generated from packages/server-shell-setup/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill server-shell-setup` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/server-shell-setup/SKILL.md))
...
Source: [`packages/server-shell-setup/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/server-shell-setup/README.md)

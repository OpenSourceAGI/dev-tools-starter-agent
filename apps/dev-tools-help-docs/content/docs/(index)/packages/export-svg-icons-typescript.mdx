...
{/* Generated from packages/export-svg-icons-typescript/readme.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill export-svg-typescript` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/export-svg-typescript/SKILL.md))
...
Source: [`packages/export-svg-icons-typescript/readme.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/export-svg-icons-typescript/readme.md)

...
{/* Generated from packages/code-tree-graph/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill code-tree-graph` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/code-tree-graph/SKILL.md))
...
Source: [`packages/code-tree-graph/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/code-tree-graph/README.md)

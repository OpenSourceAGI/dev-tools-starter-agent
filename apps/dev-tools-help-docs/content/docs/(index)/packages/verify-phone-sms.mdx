...
{/* Generated from packages/verify-phone-sms/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill verify-phone-sms` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/verify-phone-sms/SKILL.md))
...
For detailed deployment instructions, see [DEPLOYMENT.md](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/verify-phone-sms/DEPLOYMENT.md).
...
Source: [`packages/verify-phone-sms/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/verify-phone-sms/README.md)

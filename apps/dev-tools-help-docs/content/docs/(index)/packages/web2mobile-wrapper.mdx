...
description: 'Turn any website URL into a native iOS and Android app wrapper with push notifications.'
icon: Smartphone
---

{/* Generated from packages/web2mobile-wrapper/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill web2mobile` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/web2mobile/SKILL.md))
...
Source: [`packages/web2mobile-wrapper/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/web2mobile-wrapper/README.md)

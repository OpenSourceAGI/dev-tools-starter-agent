---
title: 'api2ai'
description: 'Generate production-ready MCP servers from any OpenAPI specification using the highly-used and convenient mcp-use framework'
icon: Wand2
---

{/* Generated from packages/api2ai-mcp-generator/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill api2ai` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/api2ai/SKILL.md))
...
Source: [`packages/api2ai-mcp-generator/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/api2ai-mcp-generator/README.md)

...
{/* Generated from packages/setup-git-repo/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skills**
<br />
`npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill github-actions-setup` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/github-actions-setup/SKILL.md))
<br />
`npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill git-badges` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/git-badges/SKILL.md))
...
[`starter-templates/template-git-repo/`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/starter-templates/template-git-repo)
...
- [`github-actions-setup`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/github-actions-setup/SKILL.md) — the workflows: what each needs, how each fails
- [`git-badges`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/git-badges/SKILL.md) — the badge block: every badge's setup and failure modes

---

Source: [`packages/setup-git-repo/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/setup-git-repo/README.md)

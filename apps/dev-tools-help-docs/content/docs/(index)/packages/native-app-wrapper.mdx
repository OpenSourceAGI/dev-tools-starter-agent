...
{/* Generated from packages/native-app-wrapper/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill native-app-wrapper` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/native-app-wrapper/SKILL.md))
...
- **A command-line tool** (`"mode": "local"`) — a bundled HTML frontend backed by the CLI itself,
  ...
  [`docs/LOCAL_APPS.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/native-app-wrapper/docs/LOCAL_APPS.md).
...
Source: [`packages/native-app-wrapper/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/native-app-wrapper/README.md)

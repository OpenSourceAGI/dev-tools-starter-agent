...
description: 'Cloudflare Workers queue consumer that fires a Claude Code routine whenever a Workers build fails.'
icon: Zap
---

{/* Generated from packages/cloudflare-to-claude-fix/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill cloudflare-to-claude-fix` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/cloudflare-to-claude-fix/SKILL.md))
...
Source: [`packages/cloudflare-to-claude-fix/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/cloudflare-to-claude-fix/README.md)

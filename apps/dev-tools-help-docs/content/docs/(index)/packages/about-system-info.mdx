...
{/* Generated from packages/about-system-info/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill about-system` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/about-system/SKILL.md))
...
Source: [`packages/about-system-info/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/about-system-info/README.md)

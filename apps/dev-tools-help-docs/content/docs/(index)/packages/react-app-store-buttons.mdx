...
{/* Generated from packages/react-app-store-buttons/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
**🤖 Agent skill** — `npx skills@latest add https://github.com/OpenSourceAGI/dev-tools-starter-agent --skill app-store-buttons` ([what it covers](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/skills/app-store-buttons/SKILL.md))
...
Source: [`packages/react-app-store-buttons/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/packages/react-app-store-buttons/README.md)

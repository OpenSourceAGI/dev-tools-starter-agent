---
title: 'vscode-cloud'
description: 'Per-user VS Code (code-server) instances on Cloudflare Containers, with SSO, isolated storage, and traffic routing.'
icon: Code
---

{/* Generated from apps/vscode-cloud/README.md by scripts/sync-readme-docs.ts. Edit the README, then run `bun run docs:sync`. */}
...
Non-secret values, edited in [`wrangler.jsonc`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/apps/vscode-cloud/wrangler.jsonc) → `vars` and
...
Source: [`apps/vscode-cloud/README.md`](https://github.com/OpenSourceAGI/dev-tools-starter-agent/blob/master/apps/vscode-cloud/README.md)

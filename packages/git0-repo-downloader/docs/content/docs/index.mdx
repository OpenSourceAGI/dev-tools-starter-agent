---
title: Introduction
description: Download Git Repo on Step Zero — search GitHub, download source & releases, install dependencies and open your editor.
---

![git0](https://i.imgur.com/RLXLAzY.png)

[![npm version](https://img.shields.io/npm/v/git0.svg)](https://www.npmjs.com/package/git0) [![Discord](https://img.shields.io/discord/1110227955554209923.svg?label=Chat&logo=Discord&colorB=7289da&style=flat)](https://discord.gg/SJdBqBz3tV) [![GitHub Stars](https://img.shields.io/github/stars/OpenSourceAGI/dev-tools-starter-agent)](https://github.com/OpenSourceAGI/dev-tools-starter-agent) [![GitHub Discussions](https://img.shields.io/github/discussions/OpenSourceAGI/dev-tools-starter-agent)](https://github.com/OpenSourceAGI/dev-tools-starter-agent/discussions) ![PRs welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)  

// Generated by scripts/configure.mjs from profiles/about-system.json. Do not edit by hand.
...
pub const SIDECAR_NAME: &str = "about-system";
...
pub const SIDECAR_ARGS: &[&str] = &["--json"];

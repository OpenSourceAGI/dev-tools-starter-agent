...
1. GitHub Private Vulnerability Reporting:
   https://github.com/OpenSourceAGI/dev-tools-starter-agent/security/advisories/new
...
- Unauthorized access to user data, generated projects, or provider credentials
...
- LLM-provider, package-registry, and database credentials
